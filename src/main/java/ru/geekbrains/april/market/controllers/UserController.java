...
public class UserController {
    ...
    @GetMapping("/me")
    public UserDto getCurrentUsername(User user) {
        User currentUser = userService.findByUsername(user.getUsername()).orElseThrow(() -> new ResourceNotFoundException("User doesn't exist"));
